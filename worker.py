...
class Worker:
    def __init__(self, id, dstr_sys_model):
        ...
        self.worker_thread = threading.Thread(target = self.work_target, args=(dstr_sys_model,)) 
    ...
    def work_target(self, dstr_sys_model):
        ...
        dstr_sys_model.set_global_snapshot(process.id, process.get_local_snapshot())
